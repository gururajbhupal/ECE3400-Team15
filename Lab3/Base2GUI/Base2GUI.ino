...
void loop(void)
{
    ...
    if ( radio.available() )
    {
      ...
      while (!done)
      {
        ...
        if(WallWest){Serial.print(",");Serial.print("west=true");}
        
        WallNorth = (data>>9) & 0x0001;
        if(WallNorth){Serial.print(",");Serial.print("north=true");}
        
        WallEast = (data>>10) & 0x0001;
        if(WallEast){Serial.print(",");Serial.print("east=true");}

        WallSouth = (data>>11) & 0x0001;
        if(WallSouth){Serial.print(",");Serial.print("south=true");}



        OppRobot =(data>>12) & 0x1000;
        if(OppRobot){Serial.print(",");Serial.print("robot=true");}
